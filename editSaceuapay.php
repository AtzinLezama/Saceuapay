    ...
    <div class="forma"> <br><br>
        <form action="http://localhost/Saceuapay/updateSaceuapay.php" method="post" autocomplete="OFF">
            ...
            <fieldset class="uu">
                ...
                <label style="margin-left: 57px; margin-right: 40px;" autocomplete="OFF">Id</label>&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp
                <input type="text" name="txtId" id="campo" style="width: 300px;" required="required" value="<?php echo $row['id_cargo'] ?>" readonly>
                <br><br><label style="margin-left: 57px; margin-right: 40px;" autocomplete="OFF">Numero de control</label>
                <input type="text" name="txtNumcontrol" id="campo" style="width: 300px;" required="required" value="<?php echo $row['numero_control'] ?>" readonly>
		...
		margin-left: 10px;margin-left: 235px;margin-right: 50px;cursor: pointer;background-color: #EEEEEE;border-top: 1px solid #9e9e9e;">
                ...
                <input type="text" name="txtRalumno" style="width: 300px;" required="required" id="campon" value="<?php echo $row3['nombre'] ?>" readonly><br><br><b><br>
                    ...
                    <select id="Cuatrimestre" name="txtCuatrimestre" style="width: 300px" required="required" readonly>
                        <?php echo '<option   value="' . $row['cuatrimestre'] . '">' . $row['cuatrimestre'] . '</option>'; ?>
                    ...
                    <select name="txtConcepto" style="width: 500px;" required="required">
                        ...
                        <?php
                        echo '<option   value="' . $row['id_conceptos'] . '">' . $row['id_conceptos'] . '</option>';
                        //imprime los conceptos guardados en la db
                    ...
                    <div id="contenido" name="formulario">
                        ...
                        <input type="number" pattern="[0-9]+([\.,][0-9]+)?" step="00.01" name="txtCantidad" class="form-control" id="saleP" onkeyup="discount();" required="required" value="<?php echo $row['cantidad'] ?>" />
                        ...
                        <select name="txtDescuento" class="form-control" id="discountP" onkeyup="discount();">
                            ...
                            <?php echo '<option   value="' . $row['descuento'] . '">' . $row['descuento'] . '%</option>'; ?>
                    ...
                    switch ($row['tipo_pago']) {
                        case 1:
                            echo '<option   value="' . $row['tipo_pago'] . '">Efectivo</option>';
                            break;
                        case 2:
                            echo '<option   value="' . $row['tipo_pago'] . '">Tarjeta</option>';
                            break;
                        case 3:
                            echo '<option   value="' . $row['tipo_pago'] . '">Transferencia</option>';
                            break;
                        case 4:
                            echo '<option   value="' . $row['tipo_pago'] . '">Cheque</option>';
                            break;
                    }
                    ?>
                    ...
                    <div align="center">
                        ...
                        <input type="text" name="txtComentarios" style="width: 500px; height: 50px;" value="<?php echo $row['observaciones'] ?>"><br><br>
                    </div><br>

                    <input type="submit" class="btn btnn" value="Actualizar pago">
